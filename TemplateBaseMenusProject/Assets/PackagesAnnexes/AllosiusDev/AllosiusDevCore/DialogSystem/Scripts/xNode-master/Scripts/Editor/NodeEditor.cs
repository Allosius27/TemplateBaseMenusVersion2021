...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        public virtual void OnBodyGUI() {
            ...
            string[] excludes = { "m_Script", "graph", "position", "ports", "gameActions", "gameRequirements", "showGeneralProperties", "showGameActions", "showGameRequirements", "showEnterNodeActions", "enterNodeActions" };
